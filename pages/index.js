...
export default function Home() {
  ...
  async function getUser() {
    ...
    if (userurl == undefined) {
      ...
      let newuser = 'Welcome First Timer!'
      ...
      if (picurl == 'http://10.10.20.32:8080/ipfs/'){
        getFileUrl('ipfs.png')
      }
      else {
        getFileUrl(picurl);
          ...
          <hr className="my-3" />
            <div className="row d-flex">
              ...
              <div className="col-lg-4">
                ...
                <h6 className="mt-2">Transfer MonsterBits to Personal Wallet</h6>
                <button onClick={transferERC} className="btn btn-primary mt-2">
                  Transfer MonsterBits
                </button>
